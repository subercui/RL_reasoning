...
class Executor(object):
    def __init__(self, n_qfvector, n_state, n_answer_class):
        ...
        self.params = self.answer_sm.params
...
class Reasoner(object):
    ...
    def apply(self, facts, facts_mask, question, question_mask, y):
        ...
        for t in xrange(self.T):
            ...
            # del
            # generate a distribution for location
    ...
    def log_likelihood_sym(self, actions_var, dist_info_vars, bernoulli = False):
        ...
        res = theano.printing.Print('283 line log-likehood:')(res)
        return res
...
class Reasoner_stepwise(object):
    """
    author: Cui Haotian
    the whole model
    """
